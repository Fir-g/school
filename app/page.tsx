  ...
  return (
    <main className="min-h-screen">
      ...
      <section
        ...
        style={{
          backgroundImage:
            'linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/event2.jpg")',
        }}
      >
          ...
          <div className="flex gap-4 justify-center">
            <Button asChild size="lg" variant="default">
              <Link href="/admissions">
                Admission Open <ArrowRight className="ml-2 h-4 w-4" />
              </Link>
            </Button>
            <Button
              asChild
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col items-center text-center p-6 rounded-lg border bg-card">
              ...
              <p className="text-muted-foreground">
                Dedicated teachers committed to nurturing each student's
            ...
            <div className="flex flex-col items-center text-center p-6 rounded-lg border bg-card">
              ...
              <p className="text-muted-foreground">
                Track record of academic achievement and holistic student
                development.
              </p>
            </div>
          </div>
      ...
      <section className="py-20 bg-muted/50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground">
              Stay updated with the latest happenings at Skyline Scholars
            </p>
          </div>
            ...
            {[1, 2, 3].map((i) => (
              ...
              >
                <img
                  src={
                    i === 1
                      ? "/images/event2.jpg" // Local Image
                      : i === 2
                      ? "/images/event12.JPG" // Remote Image
                      : "/images/event11.jpg"
                  }
                  alt="Event"
                ...
                <div className="p-6">
                  ...
                  <p className="text-muted-foreground mb-4">
                    {i === 1
                      ? "Students showcase their innovative science projects."
                      : i === 2
                      ? "Join us for a day of athletic excellence."
                      : "Celebrating creativity through student artwork."}
                  </p>
